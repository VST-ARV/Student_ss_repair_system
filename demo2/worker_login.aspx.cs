...
namespace demo2
{
    public partial class worker_login : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from worker WHERE id=" + user_number + "AND password=" + "'" + user_pwd + "'";    //创建查询语句 
            try
            {
                conn.Open();//打开数据库 
                ...
                else
                {
                    ...
                    Response.Write("<script language=javascript>alert('输入账号或密码错误！');window.location = 'worker_login.aspx';</script>");
